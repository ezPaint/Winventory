 ...
 * 
 * Handles the "SetGoogleClient.jsp" page which allows user to make changes to
 * the Google Client to allow Google Login.
 * 
...
public class SetGoogleClientController extends BaseController {
    ...
    /**
     * Makes sure that the GoogleClient is initialized in the DB. The
     * GoogleClient settings require that an object be pre-loaded in the DB with
     * the key of "1L".
     * 
